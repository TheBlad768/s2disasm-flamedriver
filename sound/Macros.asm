...
Gen_Sound_Table macro declsfx
	...
	declsfx Hurt
	declsfx Skidding
	declsfx MissileDissolve
	declsfx HurtBySpikes
	declsfx Sparkle
	declsfx Beep
	declsfx Bwoop
	declsfx Splash
	...
	declsfx Smash
	declsfx DoorSlam
	declsfx SpindashRelease
	declsfx Hammer
	declsfx Roll
	declsfx ContinueJingle
	declsfx CasinoBonus
	declsfx Explosion
	declsfx WaterWarning
	declsfx EnterGiantRing
	declsfx BossExplosion
	declsfx TallyEnd
	declsfx Flamethrower
	declsfx Bonus
	declsfx SpecStageEntry
	declsfx SlowSmash
	declsfx Spring
	declsfx Blip
	declsfx Signpost
	...
	declsfx Signpost2P
	declsfx OOZLidPop
	declsfx SlidingSpike
	declsfx CNZElevator
	declsfx PlatformKnock
	declsfx BonusBumper
	declsfx LargeBumper
	declsfx Gloop
	declsfx PreArrowFiring
	declsfx Fire
	declsfx ArrowStick
	declsfx Helicopter
	...
	declsfx CNZLaunch
	declsfx Flipper
	declsfx HTZLiftClick
	declsfx Leaves
	declsfx MegaMackDrop
	declsfx DrawbridgeMove
	declsfx QuickDoorSlam
	declsfx DrawbridgeDown
	declsfx LaserBurst
	declsfx Scatter
	declsfx Teleport
	declsfx Error
	declsfx MechaSonicBuzz
	declsfx LargeLaser
	declsfx OilSlide
	endm
