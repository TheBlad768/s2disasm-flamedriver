...
zSFX_Spindash         = {sfx_prefix}_SpindashRev
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
; Additional variables for different names of the same SFX.
{sfx_prefix}_ArrowFiring         = {sfx_prefix}_LavaBall
{sfx_prefix}_LaserFloor         = {sfx_prefix}_Scatter
; ---------------------------------------------------------------------------
; Internal equates for use in the driver.
